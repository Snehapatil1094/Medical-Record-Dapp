...
contract medicalRecords {
    ...
    function setDoctorDetails(
        ...
        address _doctorAddress)  public onlyHospitalOwner {
    ...
    function setPatientDetails(
        ...
        address _patientAddress)  public onlyReceptionist {
    ...
    function getDoctorDetails(uint _doctorId) public view returns(string memory, 
                                                                   string memory,
                                                                   uint,
                                                                   string memory,
                                                                   address) {
