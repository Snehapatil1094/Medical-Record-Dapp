...
var contractFunction = async function()
{       
        var operation = 'setDoctorDetails';
        var contractAddress = '0x7e6f37916bc6002ea7bd76c8be41e937ce3058c5';
            ...
            try {
                ...
                switch(operation)
                {
                    case "setDoctorDetails":
                        ...
                        var rawTransaction = {"from":myAddress, "gasPrice":web3js.utils.toHex(20* 1e9),"gasLimit":web3js.utils.toHex(990000),"to":contractAddress,"value":"0x0","data":contract.methods.setDoctorDetails(123,"Dr.Kale","kale@gmail.com",123456,"Pune","0xFd4ABA17c5c9b50bEE1899A969Df3195919d52E6").encodeABI(),"nonce":web3js.utils.toHex(count)}
                    ...
                    case "getDoctorDetails":
                        ...
                        var myAddress1 = '0xFd4ABA17c5c9b50bEE1899A969Df3195919d52E6';
                        var rawTransaction = {"from":myAddress1, "gasPrice":web3js.utils.toHex(20* 1e9),"gasLimit":web3js.utils.toHex(990000),"to":contractAddress,"value":"0x0","data":contract.methods.getDoctorDetails(123).encodeABI(),"nonce":web3js.utils.toHex(count)}
                        console.log(rawTransaction);
                        break;                        
